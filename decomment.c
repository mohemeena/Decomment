...
//writes one character output if not EO
...
/* Inside comment: skip chars, but keep newlines */
...
/* Saw '*' in a comment: maybe closing, maybe not */
...
/* Inside char literal: print until closing quote */
...
/* After backslash in char literal */
...
/* EOF reached inside comment → error */
